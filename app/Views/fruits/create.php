<div class="flex flex-col text-lg">
    ...
    <div class="flex justify-center gap-6">
        ...
        <div class="w-1/4">
            <form class="flex flex-col gap-0 group" action="<?= url_to('store') ?>" method="post" enctype="multipart/form-data">
                <div>
                    <input class=" p-6 border-2 rounded-xl w-full peer outline-none focus:border-2 focus:border-red-400 valid:border-green-400 valid:border-2" id="name" type="text" name="name" value="<?= old('name') ?>" required>
                ...
                <div>
                    <input class=" p-6 border-2 rounded-xl w-full peer outline-none focus:border-2 focus:border-red-400 valid:border-green-400 valid:border-2 appearance-none" id="price" type="text" name="price" value="<?= old('price') ?>" required>
                ...
                <div>
                    <textarea class=" p-6 border-2 rounded-xl resize-none w-full peer outline-none focus:border-2 focus:border-red-400 valid:border-green-400 valid:border-2" id="description" name="description" rows="3" required><?= old('description') ?></textarea>
